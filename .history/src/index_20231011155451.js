...
client.on('ready', () => {
    ...
    const servidor = client.guilds.cache.get('1062074461559468043'); 
    console.log(servidor.members);

    cron.schedule('52 15 * * *', () => {
        // Reemplaza con el ID de tu servidor
        const mensaje = 'Este es un recordatorio automático a las 15:30 (3:30 PM).';
    
        if (servidor) {
          servidor.members.cache.forEach(miembro => {
