...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (tasks.length == 0) {
        ...
        await interaction.reply({
        embeds: [embed],
        content: "\n Si queres devolver una tarea a la lista de pendientes, envia `/undo #` ¡Reemplaza el # con el ID correspondiente!\nPara ver las tareas que se encuentran pendientes, envia `/list-personal-tasks #` ¡Reemplaza el # con el username del miembro elegido!"
        });
        }
  } catch (err) {
