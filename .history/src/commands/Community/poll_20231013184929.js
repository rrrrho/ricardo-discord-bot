...
module.exports = {
    ...
    async execute(interaction) {
        ...
        .setColor('#6CC4A1')
        .setAuthor({ name: 'Sistema de votos', iconURL: `https://w7.pngwing.com/pngs/83/709/png-transparent-pokemon-red-and-blue-haunter-pixel-art-sprite-sprite-thumbnail.png`})
        .setTimestamp()
