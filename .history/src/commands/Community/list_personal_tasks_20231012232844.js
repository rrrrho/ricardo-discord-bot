...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addMentionableOption(option => {option.setName('Usuario a listar sus tareas.').setRequired(true)}),
  async execute(interaction) {
    try {
    const taggedUser = interaction.options.getMentionable("assign");
    ...
    await interaction.reply({
      content: `Tareas pendientes de @${task.assignTo}` + messageContent +
