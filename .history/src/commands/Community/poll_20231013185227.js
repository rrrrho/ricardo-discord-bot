...
module.exports = {
    ...
    async execute(interaction) {
        ...
        .setColor('#6CC4A1')
        .setAuthor({ name: 'Sistema de votos', iconURL: `https://e7.pngegg.com/pngimages/801/751/png-clipart-groudon-rayquaza-pixel-art-jirachi-pixel-art-pokemon-rayquaza-purple-video-game.png`})
        .setTimestamp()
