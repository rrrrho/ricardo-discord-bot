...
module.exports = {
    ...
    async execute(interaction) {
        ...
        .setColor('#6CC4A1')
        .setAuthor({ name: 'Sistema de votos', iconURL: `https://static.wikia.nocookie.net/amongus/images/5/5b/Morado.png/revision/latest?cb=20210613094134&path-prefix=es`})
        .setTimestamp()
