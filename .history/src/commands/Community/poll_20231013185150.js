...
module.exports = {
    ...
    async execute(interaction) {
        ...
        .setColor('#6CC4A1')
        .setAuthor({ name: 'Sistema de votos', iconURL: `https://c0.klipartz.com/pngpicture/842/945/sticker-png-bead-pixel-art-pattern-pokemon-design-pyssla-pokemon-purple-template-violet-bead-fictional-character.png`})
        .setTimestamp()
